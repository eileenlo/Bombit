...
public class bombByPlayer : MonoBehaviour {
	public GameObject exfire;

	PlayerAttack playerattack;
	GameObject player , mgr;
	WalkableMGRplayer walkableMGR;
	...
	void Awake(){
		...
		walkableMGR = mgr.GetComponent<WalkableMGRplayer> ();
	}

	// Use this for initialization
	void Start () {
		Range = playerattack.FireRange ;
		explosion ();
